...
#Notas(Javier): Modificado el codigo para identificar si se ejecuta en plataforma linux 
#o win32 y testear los puertos ttyS y los ttyUSB sin necesidad de realzar el enlace simbolico
