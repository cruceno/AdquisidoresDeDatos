...
#         print 'Board Num:', BoardNum
        ...
        if multimeter:
            ...
            time.sleep( 0.1 )
            self.multimeter.write( 'CONF:VOLT:DC 0.001,MAX' )
            time.sleep( 0.5 )
    ...
    def run ( self ):
        ...
        while not self.exiting:
            ...
            if self.multimeter:
                ...
                X = float ( self.multimeter.ask( 'READ?' ) ) * 1000
                
                temp_sample = 25.39459 * X 
                temp_sample-= 0.44494 * X ** 2 
                temp_sample+= 0.05652 * X ** 3 
                temp_sample-= 0.00412 * X ** 4 
                temp_sample+= 0.0011 * X ** 5 
                temp_sample-= 1.39776E-4 * X ** 6 
                temp_sample+= 4.40583E-6 * X ** 7 
                temp_sample+= 7.709E-8 * X ** 8
    ...
    def Ciclotermico_test ( self ):
        ...
        if self.cbx_temperature_sample_input.currentText() == 'AG_34410A':
            ...
            while -1 < i:
                ...
                i -= 1
            self.cbx_temperature_sample_channel.addItem( 'USB0::2391::1543::my47030898::0', 'USB0::2391::1543::my47030898::0' )
